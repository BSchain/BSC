...
def mine(block_chain, diff=5): # need to consider some condition
    ...
    try:
        ...
        if new_block_index % 5 == 0:
            block_chain.new_get_block_from_to(new_block_index - 4, new_block_index) # only check the 4 blocks
        ...
        return new_block_index,prev_hash, now_timestamp, nonce, hash_block(block.to_dict())
